 ...
 * This class is used to access database to store and retrieve student values
 */
public class studentDAO {
	...
	public studentDAO(){
        try{
        	...
        	conn = DriverManager.getConnection ("jdbc:oracle:thin:@apollo.vse.gmu.edu:1521:ite10g","arajago2", "eerdac");
        }
        catch(Exception e){
